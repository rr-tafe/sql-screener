...
ok(htmlContent.includes('id="screen-locked"'), 'Locked screen overlay present');
ok(htmlContent.includes('id="locked-candidate"'), 'Locked screen candidate name element present');
